...
public class KeyAgreementHandler extends SimpleChannelInboundHandler<Message> {
    ...
    private HsmInfo builderHsmInfo(HeadInfo headInfo) {
        ...
        return HsmInfo.builder()
                ...
                .sourceId(Arrays.copyOf("22222222222222222222222222222222".getBytes(), 32))
                ...
                .destId(Arrays.copyOf("11111111111111111111111111111111".getBytes(), 32)).ip("127.0.0.1").port(10197).build();
    }
